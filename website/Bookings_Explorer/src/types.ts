...
export type InclusionCategory = 
  | 'activity'      // bowling, VR, arcade, etc.
  | 'food'          // pizza, platters, etc.
  | 'drink'         // pitchers, sodas, etc.
  | 'equipment'     // shoes, socks, etc.
  | 'tickets'       // arcade tickets, prizes
  | 'time'          // duration-based items
  | 'service'       // host, party coordinator
  | 'other';
